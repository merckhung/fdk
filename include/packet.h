...
typedef enum {
  ...
  FDK_REQ_CONNECT = 1, FDK_RSP_CONNECT,

  FDK_REQ_DISCONNECT, FDK_RSP_DISCONNECT,

  FDK_REQ_MEM_READ, FDK_RSP_MEM_READ,

  FDK_REQ_MEM_WRITE, FDK_RSP_MEM_WRITE,

  FDK_REQ_IO_READ, FDK_RSP_IO_READ,

  FDK_REQ_IO_WRITE, FDK_RSP_IO_WRITE,

  FDK_REQ_PCI_READ, FDK_RSP_PCI_READ,

  FDK_REQ_PCI_WRITE, FDK_RSP_PCI_WRITE,

  FDK_REQ_IDE_READ, FDK_RSP_IDE_READ,

  FDK_REQ_IDE_WRITE, FDK_RSP_IDE_WRITE,

  FDK_REQ_CMOS_READ, FDK_RSP_CMOS_READ,

  FDK_REQ_CMOS_WRITE, FDK_RSP_CMOS_WRITE,

  FDK_REQ_PCI_LIST, FDK_RSP_PCI_LIST,

  FDK_REQ_E820_LIST, FDK_RSP_E820_LIST,
...
s32 executeFunction(s32 fd, fdkOpCode_t op, u64 addr, u32 size, u8 *cntBuf,
