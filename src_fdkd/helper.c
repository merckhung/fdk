...
s32 handleRequestPacket(s32 cfd, s32 memfd, fdkCommPkt_t *pFdkCommPkt,
    u32 rByte) {
  ...
  switch (pFdkCommPkt->fdkCommHdr.opCode) {
    ...
    case FDK_REQ_MEM_READ:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkRspMemReadPkt_t) - sizeof(s8 *)
          + sz;
    ...
    case FDK_REQ_IO_READ:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkRspIoReadPkt_t) - sizeof(s8 *)
          + sz;
      pFdkCommPkt->fdkCommHdr.errorCode = fdkErrCode;
    ...
    case FDK_REQ_PCI_READ:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkRspPciReadPkt_t) - sizeof(s8 *)
          + pciSz;
      pFdkCommPkt->fdkCommHdr.errorCode = FDK_SUCCESS;
    ...
    case FDK_REQ_IDE_READ:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkRspIdeReadPkt_t) - sizeof(s8 *)
          + sz;
      pFdkCommPkt->fdkCommHdr.errorCode = FDK_SUCCESS;
    ...
    case FDK_REQ_CMOS_READ:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkRspCmosReadPkt_t)
          - sizeof(s8 *) + cmosSz;
      pFdkCommPkt->fdkCommHdr.errorCode = fdkErrCode;
    ...
    case FDK_REQ_PCI_LIST:
      ...
      // Scan PCI devices
      pFdkCommPkt->fdkRspPciListPkt.numOfPciDevice = fdkPciDetectDevice(
          (fdkPciDev_t *) &pFdkCommPkt->fdkRspPciListPkt.pciListContent);

      // Prepare the response packet
      pFdkCommPkt->fdkCommHdr.opCode = FDK_RSP_PCI_LIST;
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkRspPciListPkt_t)
          - sizeof(fdkPciDev_t *)
    ...
    case FDK_REQ_E820_LIST:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkRspE820ListPkt_t)
