...
s32 executeFunction(s32 fd, fdkOpCode_t op, u64 addr, u32 size, u8 *cntBuf,
  ...
  switch (op) {
    ...
    case FDK_REQ_MEM_WRITE:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkReqMemWritePkt_t)
          - sizeof(s8 *) + size;
      break;
    ...
    case FDK_REQ_IO_WRITE:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkReqIoWritePkt_t) - sizeof(s8 *)
          + size;
      break;
    ...
    case FDK_REQ_PCI_WRITE:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkReqPciWritePkt_t)
          - sizeof(s8 *) + size;
      break;
    ...
    case FDK_REQ_IDE_WRITE:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkReqIdeWritePkt_t)
          - sizeof(s8 *) + size;
      break;
    ...
    case FDK_REQ_CMOS_WRITE:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkReqCmosWritePkt_t)
          - sizeof(s8 *) + size;
      break;
    ...
    case FDK_REQ_E820_LIST:
      ...
      pFdkCommPkt->fdkCommHdr.pktLen = sizeof(fdkReqE820ListPkt_t);
      break;
